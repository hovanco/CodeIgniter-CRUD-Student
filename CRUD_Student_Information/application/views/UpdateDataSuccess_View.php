...
<?php require('MenuNavBar_View.php') ; ?>
  <h2 class="text-xs-center display-3">Update data to database success!</h2>
  <!-- <a href="<?= base_url(); ?>index.php/AddData_Controller" class="btn btn-info btn-lg">Go to home
  <i class="fa fa-chevron-left"></i></a> -->
  <a href="<?= base_url(); ?>index.php/ShowData_Controller" class="btn btn-info btn-lg">Go to home
  <i class="fa fa-chevron-left"></i></a>
  </div>
</body>
